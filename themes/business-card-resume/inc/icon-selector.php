...
class Business_Card_Resume_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'business-card-resume'); ?>">
                      </div>
                    <?php
                    $business_card_resume_font_awesome_icon_array = business_card_resume_font_awesome_icon_array();
                    foreach ($business_card_resume_font_awesome_icon_array as $business_card_resume_font_awesome_icon) {
                            $icon_class = $this->value() == $business_card_resume_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($business_card_resume_font_awesome_icon).'"></i>
                            <span class="business-card-resume-social-class">'.esc_attr($business_card_resume_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function business_card_resume_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'business_card_resume_customizer_script' );

if(!function_exists('business_card_resume_font_awesome_icon_array')){
    function business_card_resume_font_awesome_icon_array(){
