...
<?php 
  ...
  $alignment = get_theme_mod('business_card_resume_blog_post_alignment', 'center');
  ?>
  <article class="blog-sec blogger text-center wow zoomInLeft delay-1000 p-2 mb-4 <?php echo esc_attr($alignment); ?>-align">
    ...
    <?php if ($alignment == 'image_content') { ?>
      <div class="row m-0">
          <?php if (has_post_thumbnail()&& get_theme_mod('business_card_resume_featured_image',true) == true) { ?>
          ...
          <div class="<?php echo (has_post_thumbnail()) ? 'col-lg-7 col-md-12' : 'col-lg-12 col-md-12'; ?>">
              ...
              <?php if( get_theme_mod( 'business_card_resume_metafields_date',true) != '' || get_theme_mod( 'business_card_resume_metafields_author',true) != '' || get_theme_mod( 'business_card_resume_metafields_comment',true) != '' || get_theme_mod( 'business_card_resume_metafields_time',true) != '') { ?>
                <div class="post-info p-2 mb-2">
                  <?php if( get_theme_mod( 'business_card_resume_metafields_date',true) != '') { ?>
                    <i class="<?php echo esc_attr(get_theme_mod('business_card_resume_postdate_icon',"fa fa-calendar pe-2 ")); ?>"><a href="<?php echo esc_url( get_day_link( $business_card_resume_archive_year, $business_card_resume_archive_month, $business_card_resume_archive_day)); ?>"><span class="entry-date pe-3"><?php echo esc_html( get_the_date() ); ?></span><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a>
                  <?php }?>
            ...
            <!-- Default Layout -->
              <?php 
               if(has_post_thumbnail() && get_theme_mod('business_card_resume_featured_image',true) == true) { 
                 the_post_thumbnail(); 
               }
             ?>
             <h2><a href="<?php echo esc_url(get_permalink() ); ?>"><?php the_title(); ?><span class="screen-reader-text"><?php the_title(); ?></span></a></h2>
